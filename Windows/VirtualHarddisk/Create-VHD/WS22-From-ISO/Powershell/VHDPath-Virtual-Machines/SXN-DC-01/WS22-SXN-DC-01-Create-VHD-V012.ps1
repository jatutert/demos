...
#
$TS_VHD_PATH            = 'D:\Virtualization-Home\Virtual-Machines\Microsoft-Hyper-V\Windows\Server\SXN-DC-01\SXN-DC-01.VHD'
#
#
#
#
...
#   $vhdschijfltr = (Get-DiskImage -ImagePath 'D:\Virtualization-Home\Virtual-Machines\Microsoft-Hyper-V\Windows\Server\SXN-DC-01\SXN-DC-01.VHD' | Get-Disk | Get-Partition | Get-Volume ).DriveLetter
#
#
#   #############
#   VMware Tools
