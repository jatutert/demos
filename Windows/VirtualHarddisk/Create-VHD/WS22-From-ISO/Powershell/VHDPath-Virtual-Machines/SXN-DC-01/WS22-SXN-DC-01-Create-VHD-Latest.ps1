...
#
#
Write-Host  "Powershell ISO 2 VHD Converter by TutSOFT Version 12"
#
#
#
#
...
#
#
$TS_WIN_ISO_FOLDER      = 'D:\Virtualization-Home\Installation-Media\OperatingSystems\Windows\10-11\10-22-Windows-Server-2022\Standard-DataCenter-Microsoft\'
