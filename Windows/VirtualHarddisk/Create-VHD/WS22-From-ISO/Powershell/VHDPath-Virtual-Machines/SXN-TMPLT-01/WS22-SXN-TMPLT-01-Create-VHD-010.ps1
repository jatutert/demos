...
#
$TS_WIN_UNATTEND_FOLDER = 'D:\OneDrive\OneDrive - Saxion\Repository-Playground\Development\GitHub-GitDesktop\Demos\Windows\Guest\Windows\2022\AutoUnattend\GitHub-Ruzickap\SXN-TMPLT-01\'
$TS_WIN_UNATTEND_FILE   = 'Autounattend_SXN-TMPLT-01-Latest.xml'
#
$TS_VHD_PATH            = 'D:\Virtual-Machines\Oracle-VM-Virtualbox\Windows\Server\SXN-TMPLT-01\SXN-TMPLT-01.VHD'
#
#
#   #####################
...
#   $vhdschijfltr = (Get-DiskImage -ImagePath 'D:\Virtual-Machines\Oracle-VM-Virtualbox\Windows\Server\SXN-TMPLT-01\SXN-TMPLT-01.VHD' | Get-Disk | Get-Partition | Get-Volume ).DriveLetter
#
