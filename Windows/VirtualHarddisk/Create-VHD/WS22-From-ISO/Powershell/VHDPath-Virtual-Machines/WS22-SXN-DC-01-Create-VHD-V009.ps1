...
#
$TS_VHD_PATH            = 'D:\Virtual-Machines\Oracle-VM-Virtualbox\Windows\Server\SXN-DC-01\SXN-DC-01.VHD'
#
#
#   #####################
...
#   $vhdschijfltr = (Get-DiskImage -ImagePath 'D:\Virtual-Machines\Oracle-VM-Virtualbox\Windows\Server\SXN-DC-01\SXN-DC-01.VHD' | Get-Disk | Get-Partition | Get-Volume ).DriveLetter
#
