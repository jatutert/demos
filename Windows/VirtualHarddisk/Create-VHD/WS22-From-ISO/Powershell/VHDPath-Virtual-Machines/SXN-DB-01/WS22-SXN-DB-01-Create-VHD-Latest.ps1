...
#   PowerSHELL SCRIPT
#
#   SXN-DB-01 Edition of the script
#
...
#
$TS_VHD_PATH            = 'D:\Virtual-Machines\Microsoft-Hyper-V\Windows\Server\SXN-DB-01\SXN-DB-01.VHD'
#
#
#
#
...
#
#
Write-Host "ISO2VHD Stap 3 Maken SXN-DB-01 Virtual Harddisk op basis van ISO gestart ..."
...
#   $vhdschijfltr = (Get-DiskImage -ImagePath 'D:\Virtual-Machines\Microsoft-Hyper-V\Windows\Server\SXN-DB-01\SXN-DB-01.VHD' | Get-Disk | Get-Partition | Get-Volume ).DriveLetter
#
