...
@echo Creating SXN-DC-01 virtual machine 
::
...
@IF EXIST D:\Virtual-Machines\VMware-Workstation-PRO\Windows\Server\SXN-DC-01\SXN-DC-01.VMDK (
    @REM
    forfiles /p "D:\Virtual-Machines\VMware-Workstation-PRO\Windows\Server\SXN-DC-01" /m "SXN-DC-01.VMDK" /d -30 >nul 2>&1
    @REM
    if %errorlevel%==0 (
        @REM
...
@IF EXIST "D:\Virtual-Machines\VMware-Workstation-PRO\Windows\Server\SXN-DC-01\SXN-DC-01.VMDK" (
    ...
    if %errorlevel%==0 (
        ...
        @REM
        @del /F "D:\Virtual-Machines\VMware-Workstation-PRO\Windows\Server\SXN-DC-01\SXN-DC-01.VMDK"
        @REM
    )
)
::
...
@IF EXIST "D:\Virtual-Machines\Shared\NextCloud\SXN-DC-01\SXN-DC-01.VMDK" (
    ...
    @REM
    forfiles /p "D:\Virtual-Machines\Shared\NextCloud\SXN-DC-01" /m "SXN-DC-01.VMDK" /d -30 >nul 2>&1
    @REM
    if %errorlevel%==0 (
        @REM
...
@IF EXIST D:\Virtual-Machines\VMware-Workstation-PRO\Windows\Server\SXN-DC-01\SXN-DC-01.VMX (
    @REM
    forfiles /p "D:\Virtual-Machines\VMware-Workstation-PRO\Windows\Server\SXN-DC-01" /m "SXN-DC-01.VMX" /d -30 >nul 2>&1
    @REM
    if %errorlevel%==0 (
        @REM
