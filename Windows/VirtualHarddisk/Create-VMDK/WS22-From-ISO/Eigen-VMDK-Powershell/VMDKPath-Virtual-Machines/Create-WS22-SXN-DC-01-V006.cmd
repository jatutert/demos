...
::  16 juli 2026
::
::  Kopie van Create WS22 SXN RD 01 V006 script met vervanging van RD naar DC
::
::  By John Tutert
::
...
::      NextCloud
::
@IF EXIST "C:\Users\jtu03\Nextcloud\Shared\Virtual-Machines\SXN-DC-01\SXN-DC-01.VMDK" (
    @REM
    @REM    Bepalen of het aanwezige VMDK bestand op NextCloud ouder is dan 30 dagen
    @REM
    forfiles /p "C:\Users\jtu03\Nextcloud\Shared\Virtual-Machines\SXN-DC-01" /m "SXN-DC-01.VMDK" /d -30 >nul 2>&1
    @REM
    if %errorlevel%==0 (
        @REM
        ...
        @REM
        del "C:\Users\jtu03\Nextcloud\Shared\Virtual-Machines\SXN-DC-01\SXN-DC-01.VMDK"
        @REM
    )
)
::
@IF NOT EXIST "C:\Users\jtu03\Nextcloud\Shared\Virtual-Machines\SXN-DC-01\SXN-DC-01.VMDK" (
    @REM
    @echo Overzetten VMDK uit VM Directory naar NextCloud
    @REM
    @robocopy D:\Virtual-Machines\VMware-Workstation-PRO\Windows\Server\SXN-DC-01 C:\Users\jtu03\Nextcloud\Shared\Virtual-Machines\SXN-DC-01 SXN-DC-01.VMDK /MT:16 /J /ETA
    @REM
    @REM copy D:\Virtual-Machines\VMware-Workstation-PRO\Windows\Server\SXN-DC-01\SXN-DC-01.VMDK C:\Users\jtu03\Nextcloud\Shared\Virtual-Machines\SXN-DC-01
    @REM
...
::      NextCloud
::
@IF EXIST C:\Users\jtu03\Nextcloud\Shared\Virtual-Machines\SXN-DC-01\SXN-DC-01.VMX (
    @REM
    forfiles /p "C:\Users\jtu03\Nextcloud\Shared\Virtual-Machines\SXN-DC-01" /m "SXN-DC-01.VMX" /d -30 >nul 2>&1
    @REM
    if %errorlevel%==0 (
        @REM
        @echo VMX is aanwezig maar ouder dan 30 dagen
        @echo Verwijderen VMX 
        @REM
        del "C:\Users\jtu03\Nextcloud\Shared\Virtual-Machines\SXN-DC-01\SXN-DC-01.VMX"
    )
)
::
@IF NOT EXIST C:\Users\jtu03\Nextcloud\Shared\Virtual-Machines\SXN-DC-01\SXN-DC-01.VMX (
    @REM
    @REM  VMX bestand is niet aanwezig
    @REM
