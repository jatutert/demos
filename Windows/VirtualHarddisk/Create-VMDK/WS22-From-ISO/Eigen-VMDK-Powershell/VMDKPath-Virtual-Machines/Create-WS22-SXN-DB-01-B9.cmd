...
::
Set "PowershellScriptBestand=D:\OneDrive\OneDrive - Saxion\Repository-Playground\Development\GitHub-GitDesktop\Demos\Windows\VirtualHarddisk\Create-VHD\WS22-From-ISO\Powershell\VHDPath-Virtual-Machines\SXN-DB-01\WS22-SXN-DB-01-Create-VHD-Latest.ps1"
::
@IF NOT EXIST "%PowershellScriptBestand%" (
    ...
    @echo VHD kan NIET aangemaakt worden ... 
    @echo.
    @echo Maak WS22-SXN-DB-01-Create-VHD-Latest.ps1
    @echo.
    @pause
    goto hoofdmenu
)
...
::  Controle aanwezigheid ISO bestand  
::
Set "VHDBestandVMDK=D:\Virtual-Machines\Microsoft-Hyper-V\Windows\Server\SXN-DB-01\SXN-DB-01.VHD"
::
@IF NOT EXIST "%VHDBestandVMDK%" (
    @echo SXN-DB-01 VHD bestand voor conversie is NIET gevonden
    @echo.
    @echo VMDK kan NIET aangemaakt worden ... 
    @echo.
    @echo Zorg voor SXN-DB-01.VHD
    @echo.
    @pause
    goto hoofdmenu
)
