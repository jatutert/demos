...
#
#
#	Voert versie 004 uit van autounattend.xml 
#
# 
...
VHDFormat = 'VHD' 
DiskLayout = 'UEFI'
UnattendPath = 'D:\OneDrive\OneDrive - Saxion\Repository-Playground\Development\GitHub-JATUTERT-Repositories\demos\Windows\Guest\Windows\10\AutoUnattend\SchneeGans\V004\autounattend.xml'
