...
::
@powershell -file "D:\OneDrive\OneDrive - Saxion\Repository-Playground\Development\GitHub-JATUTERT-Repositories\demos\Windows\VirtualHarddisk\VHD\W11-ISO-VHD-VM\Eigen-VHD-Powershell\VHDPath-Virtual-Machines"\W11-EDU-Schneegans-v001.ps1
::
::
:: 	[3] Create Virtual Machine
::
...
@VBoxManage -q modifyvm W11-EDU-C-WS01 --description="Windows 10 Education Autounattend Schneegans V001"
...
::
::
@move "D:\Virtual-Machines\Oracle-VM-Virtualbox\Windows\Client"\EN-US-W11-Edu-23H2.VHD "D:\Virtual-Machines\Oracle-VM-Virtualbox\Windows\Client\W11-EDU-C-WS01"\W11-EDU-C-WS01.VHD 
::
:: Verbind nieuwe VHD met de nieuwe virtuel machine 
@VBoxManage -q storageattach "W11-EDU-C-WS01" --storagectl "SATA" --port 0 --device 0 --type hdd --medium "D:\Virtual-Machines\Oracle-VM-Virtualbox\Windows\Client\W11-EDU-C-WS01\W11-EDU-C-WS01.VHD"
::
:: STarten VM
