...
::
::	Vervangen Script bestand door versie van eigen GitHub ivm foutmelding PassTru
::
powershell Invoke-WebRequest -URI    -OutFile %userprofile%\Downloads\
copy %userprofile%\Downloads\ C:\Program Files\WindowsPowerShell\Modules\Convert-WindowsImage\10.0
::
::
::
::	ISO BESTAND
...
::
::	in folder downloads staan
::	ISO-bestand
::	script
::
::	in folder downloads komt
::	VHD-bestand
::


powershell -file %userprofile%\Downloads\xxxxxxxxx.ps1
