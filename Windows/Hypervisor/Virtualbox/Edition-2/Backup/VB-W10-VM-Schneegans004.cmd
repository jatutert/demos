...
@echo Versie 6 Powershell
@echo Versie 4 Autounattend
@powershell -file "D:\OneDrive\OneDrive - Saxion\Repository-Playground\Development\GitHub-JATUTERT-Repositories\demos\Windows\Hypervisor\Virtualbox\Edition-2\W10-ISO-VHD-VM\Eigen-VHD-Powershell"\Maak-W10-Edu-VHD-uit-ISO-V006.ps1
::
::
:: 	[3] Create Virtual Machine
::
...
@VBoxManage -q storageattach "WC10O-T-001" --storagectl "SATA" --port 0 --device 0 --type hdd --medium "D:\Virtual-Machines\Oracle-VM-Virtualbox\Windows\Client\WC10O-T-001\WC10O-T-001.VHD"
::
:: STarten VM
