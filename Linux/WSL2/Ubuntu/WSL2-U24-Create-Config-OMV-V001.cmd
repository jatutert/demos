...
@IF EXIST D:\Virtual-Machines\WSL\Debian\U24-LTS-S-WSL2-001\disk1.vhdx (
    @del D:\Virtual-Machines\WSL\Debian\U24-LTS-S-WSL2-001\disk1.vhdx
)
@IF EXIST D:\Virtual-Machines\WSL\Debian\U24-LTS-S-WSL2-001\disk2.vhdx (
    @del D:\Virtual-Machines\WSL\Debian\U24-LTS-S-WSL2-001\disk2.vhdx
)
@echo DiskPart Script
@IF EXIST D:\Virtual-Machines\WSL\Debian\U24-LTS-S-WSL2-001\diskpart-script (
    @del D:\Virtual-Machines\WSL\Debian\U24-LTS-S-WSL2-001\diskpart-script
)
::
...
@mkdir D:\Virtual-Machines\WSL\Ubuntu\U24-LTS-S-WSL2-001
::
...
@wsl --install Ubuntu-24.04 --name U24-LTS-S-WSL2-001 --location D:\Virtual-Machines\WSL\Ubuntu\U24-LTS-S-WSL2-001 --no-launch >nul 2>&1
::
...
@echo create vdisk file="D:\Virtual-Machines\WSL\Ubuntu\U24-LTS-S-WSL2-001\disk1.vhdx" maximum=102400 type=expandable >>D:\Virtual-Machines\WSL\Ubuntu\U24-LTS-S-WSL2-001\diskpart-script
@echo create vdisk file="D:\Virtual-Machines\WSL\Ubuntu\U24-LTS-S-WSL2-001\disk2.vhdx" maximum=102400 type=expandable >>D:\Virtual-Machines\WSL\Ubuntu\U24-LTS-S-WSL2-001\diskpart-script
@echo exit >>D:\Virtual-Machines\WSL\Ubuntu\U24-LTS-S-WSL2-001\diskpart-script
::
::  Aanmaken VHD met behulp van DiskPart
@echo Aanmaken VHD bestanden Ubuntu 24.04 LTS binnen WSL2
@diskpart /s D:\Virtual-Machines\WSL\Ubuntu\U24-LTS-S-WSL2-001\diskpart-script >nul 2>&1
::
...
@wsl -d D13-LTS-S-OMV -u root -- bash -c "sed -i '/security.ubuntu.com/!s|URIs: .*|URIs: http://nl.archive.ubuntu.com/ubuntu/|' /etc/apt/sources.list.d/ubuntu.sources"
::
