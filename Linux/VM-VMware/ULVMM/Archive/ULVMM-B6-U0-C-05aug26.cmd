...
::
::
@echo Gebruikersinstellingen script uitlezen ...
::
::  Virtuele machines
::
...
::
@echo Curl installeren in virtuele machine ...
@"%VMWareInstallPath%"\vmrun -T ws -gu debian -gp debian runProgramInGuest %Debian13DesktopVM%\%Debian13DesktopVMName%.vmx "/bin/sudo" apt install curl -y
::
@echo Downloaden nieuwste versie LUCT vanaf GitHub John Tutert 
...
::
@echo Curl installeren in virtuele machine ...
@"%VMWareInstallPath%"\vmrun -T ws -gu debian -gp debian runProgramInGuest %Debian13ServerVM%\%Debian13ServerVMName%.vmx "/bin/sudo" apt install curl -y
::
@echo Downloaden nieuwste versie LUCT vanaf GitHub John Tutert 
