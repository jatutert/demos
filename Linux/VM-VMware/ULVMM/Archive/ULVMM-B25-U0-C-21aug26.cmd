...
@REM  Build 22    Labels
@REM  Build 23    Rocky Linux work in progress
@REM
@REM
@REM
@REM
...
@REM  Naam van de directory met Rocky Linux virtuele machines        default is Rocky
...
@REM  Naam van de directory met Rocky Desktop virtuele machines       default is desktop
@set "VWSP_VM_Linux_Rocky_Desktop_DirName=Desktop"
@REM  Naam van de directory met Rocky Server virtuele machines        default is server 
...
@REM
@REM  Namen Rocky 10 Virtuele machines
...
@echo [4] Alpine virtual machines   (Linux Virtual Images)
@echo [5] x
@echo [6] x
@echo [7] Alle Templates downloaden [niet aanwezig]
...
IF %6 == rockylinux (
   @"%VMWareInstallPath%"\vmrun -T ws -gu %6 -gp %6 runProgramInGuest %3\%4.vmx "/bin/sudo" dnf update -y
) 
IF %6 == ubuntu (
   @"%VMWareInstallPath%"\vmrun -T ws -gu %6 -gp %6 runProgramInGuest %3\%4.vmx "/bin/sudo" apt update -y
) 
