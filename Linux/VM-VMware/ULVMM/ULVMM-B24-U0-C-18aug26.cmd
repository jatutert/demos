...
@REM  :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
@REM  ::::::::
@REM  ::::::::    Declaratie Variabelen Internet
@REM  ::::::::
@REM  :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
@REM
@REM
...
@set "Debian13DesktopUrl=https://dlconusc1.linuxvmimages.com/046389e06777452db2ccf9a32efa3760:vmware/R/rockylinux/10/RockyLinux_10.1_VMG.7z"
@set "Debian13ServerUrl=https://dlconusc1.linuxvmimages.com/046389e06777452db2ccf9a32efa3760:vmware/R/rockylinux/10/RockyLinux_10.1_VMM.7z"
...
@if %antwoord%==2 goto :ubsubmenu
@if %antwoord%==1 goto :dbsubmenu
@goto :hoofdmenu
@REM
@REM
@REM  :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
@if %antwoord%==2 goto r10srv
@if %antwoord%==1 goto r10dsk
@REM
@goto hoofdmenu
...
@REM
@echo IP Adres Virtuele Machine ophalen 
for /f "delims==" %%A in ('vmrun.exe -T ws -gu rocky -gp rocky getGuestIPAddress %Rocky10DesktopVM%\%Linux_Rocky_10_Desktop_Hostname%.vmx') do set vmipadres=%%A
@REM
@REM
@echo SSH Sessie virtuele machine starten
@wt ssh -p 22 rocky@%vmipadres%
@REM
@REM
@REM  :::::::::::::::::::::::::::::::::::::::::::::::::::::
...
@REM
@echo IP Adres Virtuele Machine ophalen 
for /f "delims==" %%A in ('vmrun -T ws -gu debian -gp debian getGuestIPAddress %Rocky10ServerVM%\%Linux_Rocky_10_Server_Hostname%.vmx') do set vmipadres=%%A
@REM
@REM
@echo SSH Sessie virtuele machine starten
@wt ssh -p 22 rocky@%vmipadres%
