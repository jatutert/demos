...
::  Virtuele machines
::
::  Standaard lokatie van de virtuele machines binnen VMWare Workstation Pro op PC en/of Laptop
...
::  Templates
::
::  Standaard lokatie van templates (sjablonen) voor virtuele machines op PC en/of Laptop
...
@set "Debian12ServerVM=%VMwWrkVMPath%\%VMwWrkLinuxVM%\%VMwWrkDebianVM%\12\%VMwWrkDebianVMDName%\%Debian12ServerVMName%"
::
@set "Debian13DesktopVM=%VMwWrkVMPath%\%VMwWrkLinuxVM%\%VMwWrkDebianVM%\13\%VMwWrkDebianVMDName%\%Debian13DesktopVMName%"
@set "Debian13ServerVM=%VMwWrkVMPath%\%VMwWrkLinuxVM%\%VMwWrkDebianVM%\13\%VMwWrkDebianVMDName%\%Debian13ServerVMName%"
::
...
@echo ::::: Build %ULVMMBuild% Patch %ULVMMPatch% CHANNEL CANARY 
@echo ::::: Hoofdmenu                                                        
@echo ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
@echo.
