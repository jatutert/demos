...
@REM    Build 22    Labels
@REM    Build 23    Rocky / Alma work in progress
@REM    Build 25    Rocky / Alma complete implementatie
@REM
@REM
@REM
@REM
...
@REM  ==========================================================================================
@REM  ========
@REM  ========    Gebruikersinstellingen script
@REM  ========
@REM  ==========================================================================================
@REM
@cls
...
@set    "VWSP_VM_Default_Location=D:\Virtualization-Home\Virtual-Machines\VMware-Workstation-PRO"
@REM
@REM    Graag aanpassen naar eigen voorkeur
@REM
@REM  ==========================================================================================
@REM
@REM
...
@REM  Naam van de directory met Rocky Alma CentOS Linux virtuele machines        default is Rocky
@set "VWSP_VM_Linux_Rocky_DirName=Rocky"
...
@REM  Naam van de directory met Debian Desktop virtuele machines      default is server 
@set "VWSP_VM_Linux_Debian_Server_DirName=Server"
@REM  Naam van de directory met Rocky Alma CentOS Desktop virtuele machines       default is desktop
@set "VWSP_VM_Linux_Rocky_Desktop_DirName=Desktop"
@REM  Naam van de directory met Rocky Alma CentOS Server virtuele machines        default is server 
@set "VWSP_VM_Linux_Rocky_Server_DirName=Server"
...
@set "Linux_Debian_13_Docker_Hostname=D13-TRX-S-DKRs-001"
@REM
@REM  Namen Rocky 10 Alma CentOS Virtuele machines
@set "Linux_Rocky_10_Desktop_Hostname=R10-RQZ-D-LAB-001"
@set "Linux_Rocky_10_Server_Hostname=R10-RQZ-S-LAB-001"
@set "Linux_Rocky_10_Docker_Hostname=R10-RQZ-S-DKR-001"
@REM
...
@REM    @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ ISO Bestanden @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
@REM
@set "ISO_Default_Location=D:\Virtualization-Home\Installation-Media\OperatingSystems\Linux"
@REM
@set "ISO_Linux_Debian13_Desktop=debian-13.5.0-amd64-netinst.iso"
@set "ISO_Linux_Debian13_Server=debian-13.5.0-amd64-netinst.iso"

@REM
@REM
@REM  ==========================================================================================
@REM  ========
@REM  ========    Declaratie Bestandsnamen virtuele machines
@REM  ========
@REM  ==========================================================================================
@REM
@REM
...
@REM  Linux Virtual Images Rocky 10 bestandsnaam // D = Desktop // S = Server (minimal)
@set "LVIRocky10D=RockyLinux_10.1_VMG_LinuxVMImages.COM"
@set "LVIRocky10S=RockyLinux_10.1_VMM_LinuxVMImages.COM"
...
@REM  ==========================================================================================
@REM  ========
@REM  ========    Declaratie Download URL virtuele machines
@REM  ========
@REM  ==========================================================================================
@REM
@REM
...
@REM  Linux Virtual Images Rocky 10 download URL
@set "Rocky10DesktopUrl=https://dlconusc1.linuxvmimages.com/046389e06777452db2ccf9a32efa3760:vmware/R/rockylinux/10/RockyLinux_10.1_VMG.7z"
@set "Rocky10ServerUrl=https://dlconusc1.linuxvmimages.com/046389e06777452db2ccf9a32efa3760:vmware/R/rockylinux/10/RockyLinux_10.1_VMM.7z"
...
@set "Debian12DesktopISOUrl=https://cdimage.debian.org/cdimage/archive/12.14.0/amd64/iso-cd/debian-12.14.0-amd64-netinst.iso"
@set "Debian12ServerISOURL=https://cdimage.debian.org/cdimage/archive/12.14.0/amd64/iso-cd/debian-12.14.0-amd64-netinst.iso"
@REM  Debian 13 ISO download URL
@set "Debian13DesktopISOUrl=https://cdimage.debian.org/cdimage/archive/13.5.0/amd64/iso-cd/debian-13.5.0-amd64-netinst.iso"
@set "Debian13ServerISOURL=https://cdimage.debian.org/cdimage/archive/13.5.0/amd64/iso-cd/debian-13.5.0-amd64-netinst.iso"
...
@set "Ubuntu26DesktopISOURL=x"
@set "Ubuntu26ServerISOURL=x"
@REM
@REM
@REM  ==========================================================================================
@REM  ========
@REM  ========    Declaratie Variabelen Script Automatisch
@REM  ========
@REM  ==========================================================================================
@REM
...
@REM
@set "Rocky10DesktopVM=%VWSP_VM_Default_Location%\%VWSP_VM_Linux_DirName%\%VWSP_VM_Linux_Rocky_DirName%\10\%VWSP_VM_Linux_Rocky_Desktop_DirName%\%Linux_Rocky_10_Desktop_Hostname%"
@set "Rocky10ServerVM=%VWSP_VM_Default_Location%\%VWSP_VM_Linux_DirName%\%VWSP_VM_Linux_Rocky_DirName%\10\%VWSP_VM_Linux_Rocky_Server_DirName%\%Linux_Rocky_10_Server_Hostname%"
@REM
...
@REM
@set "Rocky10Desktop_Template_Location=%Templates_Default_Location%\%Templates_Linux_DirName%\%Templates_Linux_Rocky_DirName%\10\%Templates_Linux_Desktop_DirName%
@set "Rocky10Server_Template_Location=%Templates_Default_Location%\%Templates_Linux_DirName%\%Templates_Linux_Rocky_DirName%\10\%Templates_Linux_Server_DirName%
@REM
...
@echo [3] Rocky virtual machines    (Linux Virtual Images)
@echo [4] x virtual machines        (Linux Virtual Images)
@echo [5] x
@echo [6] x
@echo [7] Alle Templates downloaden
...
%Debian12Desktop_Template_Location% ^
%LVIDebian12D% ^
%Debian12DesktopVM% ^
%Linux_Debian_12_Desktop_Hostname% ^
%Debian12DesktopUrl% ^
debian ^
12 ^
desktop
...
@REM
call :f_maak_virtuele_machine ^
%Debian12Server_Template_Location% ^
%LVIDebian12S% ^
%Debian12ServerVM% ^
%Linux_Debian_12_Server_Hostname% ^
%Debian12ServerUrl% ^
debian ^
12 ^
server
...
@REM
call :f_maak_virtuele_machine ^
%Debian13Desktop_Template_Location% ^
%LVIDebian13D% ^
%Debian13DesktopVM% ^
%Linux_Debian_13_Desktop_Hostname% ^
%Debian13DesktopUrl% ^
debian ^
13 ^
desktop
...
@REM  ==========================================================================================
@REM  ========
@REM  ========    Debian 12 Server Open Media Vault
@REM  ========
@REM  ==========================================================================================
@REM
@REM
...
@REM  ==========================================================================================
@REM  ========
@REM  ========    Debian 13 Server Open Media Vault
@REM  ========
@REM  ==========================================================================================
@REM
@REM
...
@echo Rocky
@echo.
@echo [1] Aanmaken/Create Rocky 10 Desktop virtual machine
@echo [2] Aanmaken/Create Rocky 10 Server virtual machine
@echo [3] Aanmaken/Create Rocky 10 Docker virtual machine
@echo [4] x
@echo [5] x
@echo [6] x
@echo [7] x
...
@REM
@if %antwoord%==9 goto hoofdmenu
@if %antwoord%==8 goto rysubmenu
@if %antwoord%==7 goto rysubmenu
@if %antwoord%==6 goto rysubmenu
@if %antwoord%==5 goto rysubmenu
@if %antwoord%==4 goto rysubmenu
@if %antwoord%==3 (
    goto r10dkr
)
@if %antwoord%==2 (
...
@call :f_Toon_ULVMM_Header
@echo.
@echo Rocky 10 Desktop (Linux Virtual Images) Virtual Machine
@REM
@REM
@REM  De volgende parameters gaan naar de functie:
@REM  [1] %Debian13Desktop_Template_Location% 
...
@REM
call :f_maak_virtuele_machine ^
%Rocky10Desktop_Template_Location% ^
%LVIRocky10D% ^
%Rocky10DesktopVM% ^
%Linux_Rocky_10_Desktop_Hostname% ^
%Rocky10DesktopUrl% ^
rockylinux ^
10 ^
desktop
...
@REM
@echo IP Adres Virtuele Machine ophalen 
for /f "delims==" %%A in ('vmrun.exe -T ws -gu rockylinux -gp rockylinux getGuestIPAddress %Rocky10DesktopVM%\%Linux_Rocky_10_Desktop_Hostname%.vmx') do set vmipadres=%%A
@REM
@REM
@echo SSH Sessie virtuele machine starten
@wt ssh -p 22 rockylinux@%vmipadres%
@REM
@REM
@REM  ==========================================================================================
@REM  Rocky 10 Desktop einde
@REM  ==========================================================================================
@REM
@REM
@goto rysubmenu
...
@call :f_Toon_ULVMM_Header
@echo.
@echo Rocky 10 Server (Linux Virtual Images) Virtual Machine
@REM
@REM
@REM  De volgende parameters gaan naar de functie:
@REM  [1] %Debian13Server_Template_Location% 
...
@REM
call :f_maak_virtuele_machine ^
%Rocky10Server_Template_Location% ^
%LVIRocky10S% ^
%Rocky10ServerVM% ^
%Linux_Rocky_10_Server_Hostname% ^
%Rocky10ServerUrl% ^
rockylinux ^
10 ^
server
...
@REM
@echo IP Adres Virtuele Machine ophalen 
for /f "delims==" %%A in ('vmrun -T ws -gu rockylinux -gp rockylinux getGuestIPAddress %Rocky10ServerVM%\%Linux_Rocky_10_Server_Hostname%.vmx') do set vmipadres=%%A
@REM
@REM
@echo SSH Sessie virtuele machine starten
@wt ssh -p 22 rockylinux@%vmipadres%
...
@call :f_Toon_ULVMM_Header
@echo.
@echo Rocky 10 Server (Linux Virtual Images) Docker Virtual Machine
@REM
@REM
@REM  De volgende parameters gaan naar de functie:
@REM  [1] %Debian13Server_Template_Location% 
...
%LVIRocky10S% ^
%Rocky10ServerVM% ^
%Linux_Rocky_10_Docker_Hostname% ^
%Rocky10ServerUrl% ^
rockylinux ^
10 ^
docker
...
@REM
@REM  ==========================================================================================
@REM  Rocky 10 Server Docker einde
@REM  ==========================================================================================
@REM
@REM
@goto rysubmenu
...
if %antwoord%==7 goto :ubsubmenu
if %antwoord%==6 goto :ubsubmenu
if %antwoord%==5 goto :ubsubmenu
if %antwoord%==4 goto :ubsubmenu
...
@REM
call :f_maak_virtuele_machine ^
%Ubuntu26Desktop_Template_Location% ^
%LVIUbunu26D% %Ubuntu26DesktopVM% ^
%Linux_Ubuntu_26_Desktop_Hostname% ^
%Ubuntu26DesktopUrl% ^
ubuntu ^
26 ^
desktop
...
@cls
@REM
@echo   Downloaden templates vanaf Linux Virtual Images website
@echo.
@echo   Indien template lokaal aanwezig is wordt geen download gedaan ! 
@echo.
@echo   [1 van 9] Debian 12 Desktop
IF NOT EXIST "%Debian12Desktop_Template_Location%\%LVIDebian12D%.7z" (
    curl -L -o "%Debian12Desktop_Template_Location%"\%LVIDebian12D%.7z %Debian12DesktopUrl%
)
@echo   [2 van 9] Debian 12 Server
IF NOT EXIST "%Debian12Server_Template_Location%\%LVIDebian12S%.7z" (
    curl -L -o "%Debian12Server_Template_Location%"\%LVIDebian12S%.7z %Debian12ServerUrl%
)
@echo   [3 van 9] Debian 13 Desktop
IF NOT EXIST "%Debian13Desktop_Template_Location%\%LVIDebian13D%.7z" (
    curl -L -o "%Debian13Desktop_Template_Location%"\%LVIDebian13D%.7z %Debian13DesktopUrl%
)
@echo   [4 van 9] Debian 13 Server
IF NOT EXIST "%Debian13Server_Template_Location%\%LVIDebian13S%.7z" (
    curl -L -o "%Debian13Server_Template_Location%"\%LVIDebian13S%.7z %Debian13ServerUrl%
)
@echo   [5 van 9] Rocky 10 Desktop
IF NOT EXIST "%Rocky10Desktop_Template_Location%\%LVIRocky10D%.7z" (
    curl -L -o "%Rocky10Desktop_Template_Location%"\%LVIRocky10D%.7z %Rocky10DesktopUrl%
)
@echo   [6 van 9] Rocky 10 Server
IF NOT EXIST "%Rocky10Server_Template_Location%\%LVIRocky10S%.7z" (
    curl -L -o "%Rocky10Server_Template_Location%"\%LVIRocky10S%.7z %Rocky10ServerUrl%
)
@echo   [7 van 9] Ubuntu 24 Desktop
...
@echo   [8 van 9] Ubuntu 24 Server
IF NOT EXIST "%Ubuntu24Server_Template_Location%\%LVIUbuntu24S%.7z" (
    curl -L -o "%Ubuntu24Server_Template_Location%"\%LVIUbuntu24S%.7z %Ubuntu24ServerUrl%
)
@echo   [9 van 9] Ubuntu 26 Desktop
IF NOT EXIST "%Ubuntu26Desktop_Template_Location%\%LVIUbuntu26D%.7z" (
    curl -L -o "%Ubuntu26Desktop_Template_Location%"\%LVIUbuntu26D%.7z %Ubuntu26DesktopUrl%
)
@REM    curl -s -L -o "%Ubuntu26Server_Template_Location%"\%LVIUbuntu26S% %Ubuntu26ServerUrl%
...
@REM  ==========================================================================================
@REM  ========
@REM  ========    E I N D E    S C R I P T      ULVMM
@REM  ========
@REM  ==========================================================================================
@REM
@REM
...
@REM  ==========================================================================================
@REM  ========
@REM  ========    Declaratie Functies voor ULVMM
@REM  ========    Powered by TutSOFT
@REM  ========
@REM  ==========================================================================================
@REM
@REM
...
@REM  Rocky
@mkdir %Templates_Default_Location%\%Templates_Linux_DirName%\%Templates_Linux_Rocky_DirName% >nul 2>&1
@REM  Rocky Versie 10
@mkdir %Templates_Default_Location%\%Templates_Linux_DirName%\%Templates_Linux_Rocky_DirName%\10 >nul 2>&1
@mkdir %Rocky10Desktop_Template_Location% >nul 2>&1
@mkdir %Rocky10Server_Template_Location% >nul 2>&1
...
@REM  Rocky
@mkdir %VWSP_VM_Default_Location%\%VWSP_VM_Linux_DirName%\%VWSP_VM_Linux_Rocky_DirName% >nul 2>&1
@REM  Rocky 10
@mkdir %VWSP_VM_Default_Location%\%VWSP_VM_Linux_DirName%\%VWSP_VM_Linux_Rocky_DirName%\10 >nul 2>&1
@REM  Rocky 10 Desktop
@mkdir %VWSP_VM_Default_Location%\%VWSP_VM_Linux_DirName%\%VWSP_VM_Linux_Rocky_DirName%\10\%VWSP_VM_Linux_Rocky_Desktop_DirName% >nul 2>&1
@mkdir %VWSP_VM_Default_Location%\%VWSP_VM_Linux_DirName%\%VWSP_VM_Linux_Rocky_DirName%\10\%VWSP_VM_Linux_Rocky_Desktop_DirName%\%Linux_Rocky_10_Desktop_Hostname% >nul 2>&1
@REM  Rocky 1 Server
@mkdir %VWSP_VM_Default_Location%\%VWSP_VM_Linux_DirName%\%VWSP_VM_Linux_Rocky_DirName%\10\%VWSP_VM_Linux_Rocky_Server_DirName% >nul 2>&1
@mkdir %VWSP_VM_Default_Location%\%VWSP_VM_Linux_DirName%\%VWSP_VM_Linux_Rocky_DirName%\10\%VWSP_VM_Linux_Rocky_Server_DirName%\%Linux_Rocky_10_Server_Hostname% >nul 2>&1
...
@REM
IF %6 == debian (
    echo # Debian %4  >> %3\%4-new.vmx
)
@REM
IF %6 == rockylinux (
    echo # Rocky Linux %4  >> %3\%4-new.vmx
)
@REM
IF %6 == ubuntu (
    echo # Ubuntu %4  >> %3\%4-new.vmx
)
@REM
...
@REM
IF %6 == debian (
    @"%VMWareInstallPath%"\vmcli %3\%4.vmx ConfigParams SetEntry annotation "Username: debian Password: debian"
)
@REM
IF %6 == rockylinux (
    @"%VMWareInstallPath%"\vmcli %3\%4.vmx ConfigParams SetEntry annotation "Username: rockylinux Password: rockylinux"
)
@REM
IF %6 == ubuntu (
    @"%VMWareInstallPath%"\vmcli %3\%4.vmx ConfigParams SetEntry annotation "Username: ubuntu Password: ubuntu"
)
@REM
@REM
@REM  ================
...
@REM
IF %6 == rockylinux (
    @"%VMWareInstallPath%"\vmcli %3\%4.vmx ConfigParams SetEntry nvme0:0.fileName "%4.vmdk"
)
IF %6 == ubuntu (
    @"%VMWareInstallPath%"\vmcli %3\%4.vmx ConfigParams SetEntry scsi0:0.fileName "%4.vmdk"
)
...
@REM  @SET /a div_result=%NUMBER_OF_PROCESSORS% / 3
@REM @"%VMWareInstallPath%"\vmcli %3\%4.vmx ConfigParams SetEntry numvcpus "%div_result%"
@"%VMWareInstallPath%"\vmcli %3\%4.vmx ConfigParams SetEntry numvcpus "4"
...
@REM @"%VMWareInstallPath%"\vmcli %3\%4.vmx ConfigParams SetEntry memsize "%Host_RAM_Quarter_MB%"
@"%VMWareInstallPath%"\vmcli %3\%4.vmx ConfigParams SetEntry memsize "8192"
@REM
@REM
@REM  ================
@REM  Storage
...
@REM
if %ulvmmtestmodus% == AAN (
    @echo [Stap 11B] APT of DNF Bijwerken in virtuele machine %4
)
IF %6 == debian (
   @"%VMWareInstallPath%"\vmrun -T ws -gu %6 -gp %6 runProgramInGuest %3\%4.vmx "/bin/sudo" apt update -y
) 
IF %6 == rockylinux (
   @"%VMWareInstallPath%"\vmrun -T ws -gu %6 -gp %6 runProgramInGuest %3\%4.vmx "/bin/sudo" dnf check-update
) 
IF %6 == ubuntu (
   @"%VMWareInstallPath%"\vmrun -T ws -gu %6 -gp %6 runProgramInGuest %3\%4.vmx "/bin/sudo" apt update -y
) 
...
IF %6 == rockylinux (
   @"%VMWareInstallPath%"\vmrun -T ws -gu %6 -gp %6 runProgramInGuest %3\%4.vmx "/bin/sudo" dnf install curl jq sed wget wget2 -y
)
IF %6 == ubuntu (
   @"%VMWareInstallPath%"\vmrun -T ws -gu %6 -gp %6 runProgramInGuest %3\%4.vmx "/bin/sudo" apt install curl jq sed wget wget2 -y
)
...
if %6 == rocky (
    ...
    @REM
    @REM  ====================================================:
    @REM  VM configuratie Rocky Desktop Linux
    @REM  VM configuratie Rocky Server Linux
    @REM  ====================================================:
    @REM
    @REM
    @echo [Rocky] Bash Shell voorkeuren downloaden in virtuele machine %4
    @"%VMWareInstallPath%"\vmrun -T ws -gu %6 -gp %6 runProgramInGuest %3\%4.vmx "/bin/sudo" curl -L -o /home/rockylinux/.bashrc https://raw.githubusercontent.com/jatutert/Ubuntu-Config/main/.bashrc
    @"%VMWareInstallPath%"\vmrun -T ws -gu %6 -gp %6 runProgramInGuest %3\%4.vmx "/bin/sudo" curl -L -o /home/rockylinux/.bash_profile https://raw.githubusercontent.com/jatutert/Ubuntu-Config/main/.bash_profile
    @REM
    @REM
    @"%VMWareInstallPath%"\vmrun -T ws -gu rockylinux -gp rockylinux runProgramInGuest %3\%4.vmx "/bin/sudo" dnf install -y dnf-plugins-core
    @"%VMWareInstallPath%"\vmrun -T ws -gu rockylinux -gp rockylinux runProgramInGuest %3\%4.vmx "/bin/sudo" dnf config-manager --add-repo https://download.docker.com/linux/rhel/docker-ce.repo
    @REM
)
@REM
@REM
...
if %7 == 10 (
    ...
    @REM
    @REM  ====================================================:
    @REM  VM configuratie Rocky 10 Desktop Linux
    @REM  VM configuratie Rocky 10 Server Linux
    @REM  ====================================================:
    @REM
    @REM
    @REM  LET OP
    ...
    if %8 == desktop (
        ...
        @REM DESKTOP
        @REM
        @"%VMWareInstallPath%"\vmrun -T ws -gu rockylinux -gp rockylinux runProgramInGuest %3\%4.vmx "/bin/sudo" sed -i "s/^rockylinux10.linuxvmimages.local$/R10-RQZ-D-LAB-001/" /etc/hostname
    )
    @REM
    if %8 == server (
        @REM
        @REM SERVER
        @REM
        @"%VMWareInstallPath%"\vmrun -T ws -gu rockylinux -gp rockylinux runProgramInGuest %3\%4.vmx "/bin/sudo" sed -i "s/^rockylinux10.linuxvmimages.local$/R10-RQZ-S-LAB-001/" /etc/hostname
    )
    if %8 == docker (
        @REM
        @REM SERVER
        ...
        @"%VMWareInstallPath%"\vmrun -T ws -gu rockylinux -gp rockylinux runProgramInGuest %3\%4.vmx "/bin/sudo" sed -i "s/^rockylinux10.linuxvmimages.local$/R10-RQZ-S-LAB-001/" /etc/hostname
        @REM
        @REM    Installeer Docker-CE
        @REM
        @"%VMWareInstallPath%"\vmrun -T ws -gu rockylinux -gp rockylinux runProgramInGuest %3\%4.vmx "/bin/sudo" dnf install -y docker-ce docker-ce-cli containerd.io docker-buildx-plugin docker-compose-plugin
        @"%VMWareInstallPath%"\vmrun -T ws -gu rockylinux -gp rockylinux runProgramInGuest %3\%4.vmx "/bin/sudo" systemctl enable --now docker
        @"%VMWareInstallPath%"\vmrun -T ws -gu rockylinux -gp rockylinux runProgramInGuest %3\%4.vmx "/bin/sudo" usermod -aG docker rockylinux
    )
@REM
)
