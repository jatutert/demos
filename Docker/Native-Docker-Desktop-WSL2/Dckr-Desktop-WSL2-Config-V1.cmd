...
::
::
@echo Starten Docker Desktop en de Docker Engine
@docker desktop start
::
@echo Docker Desktop Kubernetes cluster verwijderen 
...
::
::
docker run -d --name sonarqube --network cicd-net -p 9107:9000 -e SONAR_ES_BOOTSTRAP_CHECKS_DISABLE=true sonarqube:latest
::  Jenkins
::  ::::::::
::
@echo Jenkins starten ...
@docker run -q -d --name LUCT_Jenkins --network cicd-net -p 9104:8080 -p 50000:50000 --restart=always -v jenkins_data:/var/jenkins_home jenkins/jenkins:latest-jdk21
::
:: Registry
::
