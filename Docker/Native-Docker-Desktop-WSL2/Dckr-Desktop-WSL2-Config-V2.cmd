...
::
@echo Verwijder alle Docker Volumes
...
@docker run -q -d --name LUCT_Jenkins --network devops -p 9104:8080 -p 50000:50000 --restart=always -v jenkins_data:/var/jenkins_home jenkins/jenkins:latest-jdk21
::
:: Registry
::
