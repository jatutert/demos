...
@CLS
:: 
@ECHO Canonical Multipass Docker DEMO Script 
@ECHO.  
...
@ECHO. 
@ECHO Verwijderen eventuel aanwezige (oude) docker virtuele machine     
:: 
Multipass delete ulx-s-2204-l-d-010
...
::
::
:: multipass launch docker --name ulx-s-2204-l-d-010 --cpus 2 --memory 8192M --network Ethernet
multipass launch docker --name ulx-s-2204-docker --cpus 2 --memory 8192M
::
:: 
