# Docker 
In order to give a good demonstration of Docker, it is useful to have materials that you can use for a demonstration. 
...
## MinIO
MinIO running on top of Docker 
...
The virtual machine contains Docker. Can also be used for demonstration of Kubernetes using Minikube. 
