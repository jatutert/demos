...
::  
VBoxManage controlvm ulx-s-2204-a-cntrl poweroff >nul 2>&1
VBoxManage controlvm ulx-s-2204-a-h-010 poweroff >nul 2>&1
VBoxManage controlvm ulx-s-2204-a-h-011 poweroff >nul 2>&1
:: 
:: Verwijderen Virtuele machines
:: 
VBoxManage unregistervm ulx-s-2204-a-cntrl --delete-all >nul 2>&1
VBoxManage unregistervm ulx-s-2204-a-h-010 --delete-all >nul 2>&1
VBoxManage unregistervm ulx-s-2204-a-h-011 --delete-all >nul 2>&1
::
:: Downloads
::
...
c:\PROGRA~1\7-Zip\7z x -y -o"%ANSIBLE_DEMO_DOWNLOAD%" "%ANSIBLE_DEMO_DOWNLOAD%"\UbuntuServer_22.04_VB.7z >nul 2>&1
::
@ECHO Ansible Controller ulx-s-2204-a-cntrl Bestanden overzetten 
@copy /Y "%ANSIBLE_DEMO_DOWNLOAD%"\UbuntuServer_22.04_VB_LinuxVMImages.COM.vbox "%ANSIBLE_DEMO_VIRTMACH%\Controller"\ulx-s-2204-a-cntrl.vbox >nul 2>&1
@copy /Y "%ANSIBLE_DEMO_DOWNLOAD%"\UbuntuServer_22.04_VB_LinuxVMImages.COM.vdi "%ANSIBLE_DEMO_VIRTMACH%\Controller"\ulx-s-2204-a-cntrl.vdi >nul 2>&1
:: 
...
vboxmanage clonevm ulx-s-2204-a-cntrl --basefolder=D:\Virtual-Machines\Oracle-VM-Virtualbox\Linux\Ansible-Demo\Host-010 --name=ulx-s-2204-a-h-010 --register
:: Clone maken Host 011 
vboxmanage clonevm ulx-s-2204-a-cntrl --basefolder=D:\Virtual-Machines\Oracle-VM-Virtualbox\Linux\Ansible-Demo\Host-011 --name=ulx-s-2204-a-h-011 --register
::
...
vboxmanage modifyvm ulx-s-2204-a-cntrl --description="Ansible DEMO Controller Username/Password Ubuntu"
:: ram aanpassen 
vboxmanage modifyvm ulx-s-2204-a-cntrl --memory=4096
:: copy past modus
vboxmanage modifyvm ulx-s-2204-a-cntrl --clipboard-mode=bidirectional --drag-and-drop=bidirectional
:: netwerk aanpassen 
vboxmanage modifyvm ulx-s-2204-a-cntrl --nic2=hostonly --nictype2=82540EM --nic-promisc2=allow-all --cableconnected2=on --hostonlyadapter2="VirtualBox Host-Only Ethernet Adapter"
:: Shared Folders met Host toevoegen 
vboxmanage sharedfolder remove ulx-s-2204-a-cntrl --name="downloads" >nul 2>&1
vboxmanage sharedfolder add ulx-s-2204-a-cntrl --name="downloads" --hostpath="%USERPROFILE%\Downloads" --automount --auto-mount-point="/home/ubuntu/downloads"
::
:: Aanpassen Ansible HOST 010 Virtualbox Virtuele Machine 
:: Beschrijving aanpassen 
vboxmanage modifyvm ulx-s-2204-a-h-010 --description="Ansible DEMO Host 010 Username/Password Ubuntu"
:: ram aanpassen 
vboxmanage modifyvm ulx-s-2204-a-h-010 --memory=4096
:: copy past modus
vboxmanage modifyvm ulx-s-2204-a-h-010 --clipboard-mode=bidirectional --drag-and-drop=bidirectional
:: netwerk aanpassen 
vboxmanage modifyvm ulx-s-2204-a-h-010 --nic2=hostonly --nictype2=82540EM --nic-promisc2=allow-all --cableconnected2=on --hostonlyadapter2="VirtualBox Host-Only Ethernet Adapter"
::
:: Aanpassen Ansible Host 011 Virtualbox Virtuele Machine 
:: Beschrijving aanpassen 
vboxmanage modifyvm ulx-s-2204-a-h-011 --description="Ansible DEMO Host 011 Username/Password Ubuntu"
:: ram aanpassen 
vboxmanage modifyvm ulx-s-2204-a-h-011 --memory=4096
:: copy past modus
vboxmanage modifyvm ulx-s-2204-a-h-011 --clipboard-mode=bidirectional --drag-and-drop=bidirectional
:: netwerk aanpassen 
vboxmanage modifyvm ulx-s-2204-a-h-011 --nic2=hostonly --nictype2=82540EM --nic-promisc2=allow-all --cableconnected2=on --hostonlyadapter2="VirtualBox Host-Only Ethernet Adapter"
::
:: Virtuele Machine Starten 
:: ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
::
:: Starten Ansible Controller ulx-s-2204-a-cntrl
@vboxmanage startvm ulx-s-2204-a-cntrl --type=gui
TIMEOUT /T 15 /NOBREAK
::
:: Starten Ansible Host ulx-s-2204-a-h-010
@vboxmanage startvm ulx-s-2204-a-h-010 --type=gui
TIMEOUT /T 15 /NOBREAK
::
:: Starten Ansible Host ulx-s-2204-a-h-011
@vboxmanage startvm ulx-s-2204-a-h-011 --type=gui
::
:: Virtuele Machine PORT Forwarding Instellen 
:: ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
::
:: Ansible Controller ulx-s-2204-a-cntrl
@vboxmanage controlvm ulx-s-2204-a-cntrl natpf1 guestssh,tcp,,2222,,22
::
:: Ansible Host ulx-s-2204-a-h-010 
@vboxmanage controlvm ulx-s-2204-a-h-010 natpf1 guestssh,tcp,,2223,,22
::
:: Ansible Host ulx-s-2204-a-h-011 
@vboxmanage controlvm ulx-s-2204-a-h-011 natpf1 guestssh,tcp,,2224,,22
::
::
...
ssh -i %USERPROFILE%\.ssh\id_rsa ubuntu@127.0.0.1 -p 2222 sudo apt update -qq
::
:: Installeren Virtualbox Guest Additions Na afloop reboot noodzakelijk om te activeren 
ssh -i %USERPROFILE%\.ssh\id_rsa ubuntu@127.0.0.1 -p 2222 sudo apt remove open-vm-tools -y 
ssh -i %USERPROFILE%\.ssh\id_rsa ubuntu@127.0.0.1 -p 2222 sudo apt install -y virtualbox-guest-additions-iso
ssh -i %USERPROFILE%\.ssh\id_rsa ubuntu@127.0.0.1 -p 2222 sudo apt install -y virtualbox-guest-utils 
ssh -i %USERPROFILE%\.ssh\id_rsa ubuntu@127.0.0.1 -p 2222 sudo adduser ubuntu vboxsf 
:: 
:: Installatie cURL in Ansible Controller ulx-s-2204-a-cntrl VM 
ssh -i %USERPROFILE%\.ssh\id_rsa ubuntu@127.0.0.1 -p 2222 sudo snap install curl 
:: 
