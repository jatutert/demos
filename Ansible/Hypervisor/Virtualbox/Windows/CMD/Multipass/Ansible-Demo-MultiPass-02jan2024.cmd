...
@ECHO. 
::
:: Python moet hier nog staan tbv virtualbox
::
::
...
:: Virtualbox instellen als primaire driver voor multipass 
...
::
@ECHO Multipass Starten Virtuele machines  
:: Naslag:
::
:: cloud-init 
:: @multipass launch lts --name ulx-s-2204-l-a-001 --cpus 2 --memory 8192M --disk 50g --cloud-init [YAML] 
:: network parameter
:: https://discourse.ubuntu.com/t/how-to-add-network-interfaces/19544
:: 
:: Ansible Controller
:: @multipass launch lts --name ulx-s-2204-a-cntrl --cpus 2 --memory 8192M --disk 50g --network Ethernet
@multipass launch lts --name ulx-s-2204-a-cntrl --cpus 2 --memory 4096M --disk 50g
:: Ansible Host 
:: @multipass launch lts --name ulx-s-2204-l-a-010 --cpus 2 --memory 8192M --disk 50g --network Ethernet
@multipass launch lts --name ulx-s-2204-a-h-010 --cpus 2 --memory 4096M --disk 50g
::
...
:: GETEST 24 december Werk met -- network ethernet moet modifyvm zijn controlvm werkt niet geeft foutmelding 1  
psexec "c:\program files\oracle\virtualbox\vboxmanage" modifyvm ulx-s-2204-a-cntrl --nic2=hostonly --nictype2=82540EM --nic-promisc2=allow-all --cableconnected2=on --hostonlyadapter2="VirtualBox Host-Only Ethernet Adapter"
...
multipass exec ulx-s-2204-a-cntrl -- sudo netplan set ethernets.enp0s8.dhcp4=true
multipass exec ulx-s-2204-a-cntrl -- sudo netplan apply
::
...
multipass exec ulx-s-2204-a-cntrl -- sudo sed "s@archive.ubuntu.com@nl.archive.ubuntu.com@" -i /etc/apt/sources.list
...
multipass exec ulx-s-2204-a-cntrl -- sudo apt update >nul 2>&1
multipass exec ulx-s-2204-l-a-010 -- sudo apt update >nul 2>&1
::
multipass exec ulx-s-2204-a-cntrl -- sudo snap install curl >nul 2>&1
