...
:: @VBoxManage.exe clonemedium disk --format=VDI "%VIRT_MACHINES_TEMPLATE_DIRECTORY%\%OSTICKET_DEMO_VAGRANT_HDU_VB_VMDK%" %VIRT_MACHINES_TEMPLATE_DIRECTORY%\%OSTICKET_DEMO_VDI_TEMPLATE_FILE%
:: 
::
...
::
@copy /Y "%OSTICKET_DEMO_VAGRANT_HDU_TEMPLATE_VM_DIR%\%OSTICKET_DEMO_VAGRANT_HDU_VM_VMDK%" "%OSTICKET_DEMO_VM_DIRECTORY%\%OSTICKET_DEMO_WEBSRV_HOSTNAME%\%OSTICKET_DEMO_WEBSRV_HOSTNAME%.VMDK"
@copy /Y "%OSTICKET_DEMO_VAGRANT_HDU_TEMPLATE_VM_DIR%\%OSTICKET_DEMO_VAGRANT_HDU_VM_VMDK%" "%OSTICKET_DEMO_VM_DIRECTORY%\%OSTICKET_DEMO_DBSRV_HOSTNAME%\%OSTICKET_DEMO_DBSRV_HOSTNAME%.VMDK"
::
...
@%userprofile%\sshpass -p vagrant ssh -i %USERPROFILE%\.ssh\id_rsa %OSTICKET_DEMO_VAGRANT_LNX_USER%@127.0.0.1 -p %OSTICKET_DEMO_VM_CNTRL_SSH_PORT% -o StrictHostKeyChecking=no sudo sed 's@"1"@"0"@' -i /etc/apt/apt.conf.d/20auto-upgrades
@%userprofile%\sshpass -p vagrant ssh -i %USERPROFILE%\.ssh\id_rsa %OSTICKET_DEMO_VAGRANT_LNX_USER%@127.0.0.1 -p %OSTICKET_DEMO_VM_H10_SSH_PORT% -o StrictHostKeyChecking=no sudo sed 's@"1"@"0"@' -i /etc/apt/apt.conf.d/20auto-upgrades
:: 
::
::	#### Configuratie DNS ivm EduRoam
::
@echo Aanpassen DNS configuratie ivm EduRoam 
@%userprofile%\sshpass -p vagrant ssh -i %USERPROFILE%\.ssh\id_rsa %OSTICKET_DEMO_VAGRANT_LNX_USER%@127.0.0.1 -p %OSTICKET_DEMO_VM_CNTRL_SSH_PORT% sudo sed "s@4.2.2.1@145.76.2.75@" -i /etc/netplan/01-netcfg.yaml
@%userprofile%\sshpass -p vagrant ssh -i %USERPROFILE%\.ssh\id_rsa %OSTICKET_DEMO_VAGRANT_LNX_USER%@127.0.0.1 -p %OSTICKET_DEMO_VM_CNTRL_SSH_PORT% sudo sed "s@4.2.2.2@145.76.2.85@" -i /etc/netplan/01-netcfg.yaml
@%userprofile%\sshpass -p vagrant ssh -i %USERPROFILE%\.ssh\id_rsa %OSTICKET_DEMO_VAGRANT_LNX_USER%@127.0.0.1 -p %OSTICKET_DEMO_VM_CNTRL_SSH_PORT% sudo sed "s@208.67.220.220@145.2.14.10, 8.8.8.8, 8.8.4.4@" -i /etc/netplan/01-netcfg.yaml
@%userprofile%\sshpass -p vagrant ssh -i  %USERPROFILE%\.ssh\id_rsa %OSTICKET_DEMO_VAGRANT_LNX_USER%@127.0.0.1 -p %OSTICKET_DEMO_VM_CNTRL_SSH_PORT% sudo netplan apply
::
@echo Aanpassen DNS configuratie ivm EduRoam 
@%userprofile%\sshpass -p vagrant ssh -i %USERPROFILE%\.ssh\id_rsa %OSTICKET_DEMO_VAGRANT_LNX_USER%@127.0.0.1 -p %OSTICKET_DEMO_VM_H10_SSH_PORT% sudo sed "s@4.2.2.1@145.76.2.75@" -i /etc/netplan/01-netcfg.yaml
@%userprofile%\sshpass -p vagrant ssh -i %USERPROFILE%\.ssh\id_rsa %OSTICKET_DEMO_VAGRANT_LNX_USER%@127.0.0.1 -p %OSTICKET_DEMO_VM_H10_SSH_PORT% sudo sed "s@4.2.2.2@145.76.2.85@" -i /etc/netplan/01-netcfg.yaml
@%userprofile%\sshpass -p vagrant ssh -i %USERPROFILE%\.ssh\id_rsa %OSTICKET_DEMO_VAGRANT_LNX_USER%@127.0.0.1 -p %OSTICKET_DEMO_VM_H10_SSH_PORT% sudo sed "s@208.67.220.220@145.2.14.10, 8.8.8.8, 8.8.4.4@" -i /etc/netplan/01-netcfg.yaml
@%userprofile%\sshpass -p vagrant ssh -i %USERPROFILE%\.ssh\id_rsa %OSTICKET_DEMO_VAGRANT_LNX_USER%@127.0.0.1 -p %OSTICKET_DEMO_VM_H10_SSH_PORT% sudo netplan apply
::
::	#### Configuratie eth1 nic 
::
@echo Netwerkkaart eth1 activeren ... 
@%userprofile%\sshpass -p vagrant ssh -i %USERPROFILE%\.ssh\id_rsa %OSTICKET_DEMO_VAGRANT_LNX_USER%@127.0.0.1 -p %OSTICKET_DEMO_VM_CNTRL_SSH_PORT% "sudo curl -s -o /etc/netplan/00-installer-config.yaml https://raw.githubusercontent.com/jatutert/demos/main/Docker/Virtualbox/Linux/Netplan/00-installer-config.yaml"
@%userprofile%\sshpass -p vagrant ssh -i %USERPROFILE%\.ssh\id_rsa %OSTICKET_DEMO_VAGRANT_LNX_USER%@127.0.0.1 -p %OSTICKET_DEMO_VM_CNTRL_SSH_PORT% "sudo netplan apply"
:: 
@echo Netwerkkaart eth1 activeren ... 
@%userprofile%\sshpass -p vagrant ssh -i %USERPROFILE%\.ssh\id_rsa %OSTICKET_DEMO_VAGRANT_LNX_USER%@127.0.0.1 -p %OSTICKET_DEMO_VM_H10_SSH_PORT% "sudo curl -s -o /etc/netplan/00-installer-config.yaml https://raw.githubusercontent.com/jatutert/demos/main/Docker/Virtualbox/Linux/Netplan/00-installer-config.yaml"
@%userprofile%\sshpass -p vagrant ssh -i %USERPROFILE%\.ssh\id_rsa %OSTICKET_DEMO_VAGRANT_LNX_USER%@127.0.0.1 -p %OSTICKET_DEMO_VM_H10_SSH_PORT% "sudo netplan apply"
:: 
::	#### Aanpassen hostname zonder herstart Verandering is zichtbaar na uitloggen en dan weer inloggen 
@%userprofile%\sshpass -p vagrant ssh -i %USERPROFILE%\.ssh\id_rsa %OSTICKET_DEMO_VAGRANT_LNX_USER%@127.0.0.1 -p %OSTICKET_DEMO_VM_CNTRL_SSH_PORT% sudo hostnamectl set-hostname %OSTICKET_DEMO_WEBSRV_HOSTNAME%
@%userprofile%\sshpass -p vagrant ssh -i %USERPROFILE%\.ssh\id_rsa %OSTICKET_DEMO_VAGRANT_LNX_USER%@127.0.0.1 -p %OSTICKET_DEMO_VM_H10_SSH_PORT% sudo hostnamectl set-hostname %OSTICKET_DEMO_DBSRV_HOSTNAME%
::
:: #### Aanpassen Ubuntu Repository 
@%userprofile%\sshpass -p vagrant ssh -i %USERPROFILE%\.ssh\id_rsa %OSTICKET_DEMO_VAGRANT_LNX_USER%@127.0.0.1 -p %OSTICKET_DEMO_VM_CNTRL_SSH_PORT% sudo sed 's@mirrors.edge.kernel.org@nl.archive.ubuntu.com@' -i /etc/apt/sources.list
@%userprofile%\sshpass -p vagrant ssh -i %USERPROFILE%\.ssh\id_rsa %OSTICKET_DEMO_VAGRANT_LNX_USER%@127.0.0.1 -p %OSTICKET_DEMO_VM_H10_SSH_PORT% sudo sed 's@mirrors.edge.kernel.org@nl.archive.ubuntu.com@' -i /etc/apt/sources.list
:: 
:: #### Updaten Ubuntu Repository
@%userprofile%\sshpass -p vagrant ssh -i %USERPROFILE%\.ssh\id_rsa %OSTICKET_DEMO_VAGRANT_LNX_USER%@127.0.0.1 -p %OSTICKET_DEMO_VM_CNTRL_SSH_PORT% "sudo apt-get update -qq" >nul 2>&1
@%userprofile%\sshpass -p vagrant ssh -i %USERPROFILE%\.ssh\id_rsa %OSTICKET_DEMO_VAGRANT_LNX_USER%@127.0.0.1 -p %OSTICKET_DEMO_VM_H10_SSH_PORT% "sudo apt-get update -qq" >nul 2>&1
::
:: #### Upgraden Ubuntu
@%userprofile%\sshpass -p vagrant ssh -i %USERPROFILE%\.ssh\id_rsa %OSTICKET_DEMO_VAGRANT_LNX_USER%@127.0.0.1 -p %OSTICKET_DEMO_VM_CNTRL_SSH_PORT% "sudo apt-get upgrade -y "
@%userprofile%\sshpass -p vagrant ssh -i %USERPROFILE%\.ssh\id_rsa %OSTICKET_DEMO_VAGRANT_LNX_USER%@127.0.0.1 -p %OSTICKET_DEMO_VM_H10_SSH_PORT% "sudo apt-get upgrade -y "
::

:: VirtualBox Extentions Installeren in virtuele machine 
:: 
:: Installatie in Host 1
@%userprofile%\sshpass -p vagrant ssh -i %USERPROFILE%\.ssh\id_rsa %OSTICKET_DEMO_VAGRANT_LNX_USER%@127.0.0.1 -p %OSTICKET_DEMO_VM_CNTRL_SSH_PORT% "sudo apt-get remove open-vm-tools -y"
@%userprofile%\sshpass -p vagrant ssh -i %USERPROFILE%\.ssh\id_rsa %OSTICKET_DEMO_VAGRANT_LNX_USER%@127.0.0.1 -p %OSTICKET_DEMO_VM_CNTRL_SSH_PORT% "sudo apt-get install -y virtualbox-guest-additions-iso"
@%userprofile%\sshpass -p vagrant ssh -i %USERPROFILE%\.ssh\id_rsa %OSTICKET_DEMO_VAGRANT_LNX_USER%@127.0.0.1 -p %OSTICKET_DEMO_VM_CNTRL_SSH_PORT% "sudo apt-get install -y virtualbox-guest-utils"
@%userprofile%\sshpass -p vagrant ssh -i %USERPROFILE%\.ssh\id_rsa %OSTICKET_DEMO_VAGRANT_LNX_USER%@127.0.0.1 -p %OSTICKET_DEMO_VM_CNTRL_SSH_PORT% "sudo adduser vagrant vboxsf"
::
:: Installatie in Host 2
::
:: Nog toevoegen
::
...
@%userprofile%\sshpass -p vagrant ssh -i %USERPROFILE%\.ssh\id_rsa %OSTICKET_DEMO_VAGRANT_LNX_USER%@127.0.0.1 -p %OSTICKET_DEMO_VM_CNTRL_SSH_PORT% "sudo apt-get autoremove -y "
@%userprofile%\sshpass -p vagrant ssh -i %USERPROFILE%\.ssh\id_rsa %OSTICKET_DEMO_VAGRANT_LNX_USER%@127.0.0.1 -p %OSTICKET_DEMO_VM_H10_SSH_PORT% "sudo apt-get autoremove -y"
::
:: #### Downloaden Introductie Infrastructuren scripts vanaf github 
@%userprofile%\sshpass -p vagrant ssh -i %USERPROFILE%\.ssh\id_rsa %OSTICKET_DEMO_VAGRANT_LNX_USER%@127.0.0.1 -p %OSTICKET_DEMO_VM_CNTRL_SSH_PORT% "curl -s -o /home/vagrant/install-mysqlserver.sh https://raw.githubusercontent.com/jatutert/demos/main/Docker/Virtualbox/Linux/Ubuntu-Config/docker-demo-virtbox-linux-config-v001.sh"
@%userprofile%\sshpass -p vagrant ssh -i %USERPROFILE%\.ssh\id_rsa %OSTICKET_DEMO_VAGRANT_LNX_USER%@127.0.0.1 -p %OSTICKET_DEMO_VM_H10_SSH_PORT% "curl -s -o /home/vagrant/install-webserver-UB22.sh https://raw.githubusercontent.com/jatutert/demos/main/Docker/Virtualbox/Linux/Ubuntu-Config/docker-demo-virtbox-linux-config-v001.sh"
::
:: #### Uitvoerbaar maken Introductie Infrastructuren scripts
@%userprofile%\sshpass -p vagrant sdsh -i %USERPROFILE%\.ssh\id_rsa %OSTICKET_DEMO_VAGRANT_LNX_USER%@127.0.0.1 -p %OSTICKET_DEMO_VM_CNTRL_SSH_PORT% "sudo chmod +x /home/vagrant/install-mysqlserver.sh"
@%userprofile%\sshpass -p vagrant ssh -i %USERPROFILE%\.ssh\id_rsa %OSTICKET_DEMO_VAGRANT_LNX_USER%@127.0.0.1 -p %OSTICKET_DEMO_VM_H10_SSH_PORT% "sudo chmod +x /home/vagrant/install-webserver-UB22.sh"
:: 
...
:: 
:: @%userprofile%\sshpass -p vagrant ssh -i %USERPROFILE%\.ssh\id_rsa %OSTICKET_DEMO_VAGRANT_LNX_USER%@127.0.0.1 -p %OSTICKET_DEMO_VM_CNTRL_SSH_PORT% "sudo /home/vagrant/install-mysqlserver.sh"
:: @%userprofile%\sshpass -p vagrant ssh -i %USERPROFILE%\.ssh\id_rsa %OSTICKET_DEMO_VAGRANT_LNX_USER%@127.0.0.1 -p %OSTICKET_DEMO_VM_H10_SSH_PORT% "sudo /home/vagrant/install-webserver-UB22.sh"
::
::
::  
:: 
