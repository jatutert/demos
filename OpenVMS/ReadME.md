Sometimes it is necessary to give a demonstration of OpenVMS to friends and colleagues, but also to students.

This repository contains as much material as possible to enable you to give a good demonstration. 
It is divided into folders. Each folder contains material for the demonstration in question.

Feel free to use this material for a demonstration. 
Please use it for personal and/or educational purposes only.  

## License / Copyright / Trademarks 
> - Docker by Docker (docker.com) 
> - Kubernetes by Linux Foundation (linuxfoundation.org) 
> - VAX/VMS, VMS, OpenVMS by VSI (VMS Software Inc.) / HPE (Compaq/DEC) 
